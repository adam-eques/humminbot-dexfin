...
class DexfinOrderBookTests(TestCase):

    def test_snapshot_message_from_exchange(self):
        snapshot_message = DexfinOrderBook.snapshot_message_from_exchange(
            msg={
                "timestamp": 1,
                "bids": [
        ...
        # self.assertEqual(1, snapshot_message.timestamp)
    ...
    def test_trade_message_from_exchange(self):
        ...
        trade_message = DexfinOrderBook.trade_message_from_exchange(
            msg=trade_update,
            metadata={"trading_pair": "COINALPHA-HBOT"}
        )
